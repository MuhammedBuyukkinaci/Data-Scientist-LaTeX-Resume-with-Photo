...
\aboutme{
I am a T-shaped Data Scientist who has general knowledge & experience on different IT areas such as Back-end Development, Data Engineering, Testing, System Engineering, Containerization etc. I have been coding in Python for more than 5 years. My passion is to extract insights & value through Data Science techniques. I am not only an IT Engineer but also a life-long learner. I am able to create real-world Data Science projects in an end-to-end pipeline. I am trying to follow and implement SOLID principles as much as possible. I am also trying to integrate MLOps practices into my job.

Speaking of my personality, I am an extrovert, open-minded & ambitious person. I also have excellent communication skills. I am using my soft and hard skills to be one of the best Data Scientists in the industry.
}
...
\begin{twenty}
    \twentyitem
		...
		{\begin{itemize}
			...
			\item Actively using AWS, Kafka, RabbitMQ, Spark, Hadoop and Docker.
		\end{itemize}}
		\\
	\twentyitem
		{Oct 2019}
...
\begin{twenty} % Environment for a list with descriptions
	...
	{}
	{
		{\begin{itemize}
				...
				\item Obtaining an important fractional signal for trading.
		\end{itemize}}
	}
	\\
