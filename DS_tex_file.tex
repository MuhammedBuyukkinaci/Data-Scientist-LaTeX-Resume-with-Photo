...
\programming{{$\textbullet$ Jenkins $\textbullet$ Spark $\textbullet$ Kubernetes / 2.0}, {$\textbullet$ Microsoft Office $\textbullet$ MLOps $\textbullet$ Hadoop / 3.0}, {$\textbullet$ Linux $\textbullet$ SQL $\textbullet$ Git / 4.0}, 
{$\textbullet$ AWS $\textbullet$ Airflow $\textbullet$ Docker / 5.0}, 
...
\cvjobtitle{\hspace{0.05cm}Senior Data Scientist} % My position.
% title/career
...
I am a T-shaped Data Scientist who has general knowledge and experience on different IT areas such as Machine Learning Engineering, Amazon Web Services, System Engineering, Back-End Development, Data Engineering and Software Testing. I have more than 7 years of experience in Python.
